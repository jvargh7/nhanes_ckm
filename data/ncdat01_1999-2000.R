...
# For 1999-2000
alb19992000 <- read_xpt(paste0(path_nhanes_ckm_raw,"/1999-2000/LAB16.XPT")) %>%
  # Select columns
...
biopro19992000 <- read_xpt(paste0(path_nhanes_ckm_raw,"/1999-2000/LAB18.XPT")) %>%
  # Select columns
...
bmx19992000 <- read_xpt(paste0(path_nhanes_ckm_raw,"/1999-2000/BMX.XPT")) %>%
  # Select columns
...
bpq19992000 <- read_xpt(paste0(path_nhanes_ckm_raw,"/1999-2000/BPQ.XPT")) %>%
  # Select columns
...
bpx19992000 <- read_xpt(paste0(path_nhanes_ckm_raw,"/1999-2000/BPX.XPT")) %>%
  # Select columns
...
cdq19992000 <- read_xpt(paste0(path_nhanes_ckm_raw,"/1999-2000/CDQ.XPT")) %>%
  # Select columns
...
demo19992000 <- read_xpt(paste0(path_nhanes_ckm_raw,"/1999-2000/DEMO.XPT"))%>%
  # Select columns
...
diq19992000 <- read_xpt(paste0(path_nhanes_ckm_raw,"/1999-2000/DIQ.XPT")) %>%
  # Select columns
...
fastqx19992000 <- read_xpt(paste0(path_nhanes_ckm_raw,"/1999-2000/PH.XPT")) %>%
  # Select columns
...
ghb19992000 <- read_xpt(paste0(path_nhanes_ckm_raw,"/1999-2000/LAB10.XPT")) %>%
  # Select columns
...
glu19992000 <- read_xpt(paste0(path_nhanes_ckm_raw,"/1999-2000/LAB10AM.XPT")) %>%
  # Select columns
...
hdl19992000 <- read_xpt(paste0(path_nhanes_ckm_raw,"/1999-2000/LAB13.XPT")) %>%
  # Select columns
...
huq19992000 <- read_xpt(paste0(path_nhanes_ckm_raw,"/1999-2000/HUQ.XPT")) %>%
  # Select columns
...
ins19992000 <- read_xpt(paste0(path_nhanes_ckm_raw,"/1999-2000/LAB10AM.XPT")) %>%
  # Select columns
...
kiq19992000 <- read_xpt(paste0(path_nhanes_ckm_raw,"/1999-2000/KIQ.XPT")) %>%
  # Select columns
...
mcq19992000 <- read_xpt(paste0(path_nhanes_ckm_raw,"/1999-2000/MCQ.XPT")) %>%
  # Select columns
...
smq19992000 <- read_xpt(paste0(path_nhanes_ckm_raw,"/1999-2000/SMQ.XPT")) %>%
  # Select columns
...
smqrtu19992000 <- read_xpt(paste0(path_nhanes_ckm_raw,"/1999-2000/SMQMEC.XPT")) %>%
  # Select columns
...
trigly19992000 <- read_xpt(paste0(path_nhanes_ckm_raw,"/1999-2000/LAB13AM.XPT")) %>%
  # Select columns
