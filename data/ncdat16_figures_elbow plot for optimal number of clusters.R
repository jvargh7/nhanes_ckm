...
ggsave(elbow_plot,filename=paste0(path_nhanes_ckm_folder,"/figures/elbow plot for optimal number of clusters.png"),width=6, height = 4)

# Four clusters appear to be optimal.