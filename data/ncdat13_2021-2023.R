...
bmx20212023 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2021-2023/BMX_L.XPT")) %>%
  # Select columns
...
bpq20212023 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2021-2023/BPQ_L.XPT")) %>%
  # Select columns
...
bpxo20212023 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2021-2023/BPXO_L.XPT")) %>%
  # Select columns
...
demo20212023 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2021-2023/DEMO_L.XPT")) %>%
  # Select columns
...
diq20212023 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2021-2023/DIQ_L.XPT")) %>%
  # Select columns
...
ghb20212023 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2021-2023/GHB_L.XPT")) %>%
  # Select columns
...
glu20212023 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2021-2023/GLU_L.XPT")) %>%
  # Select columns
...
hdl20212023 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2021-2023/HDL_L.XPT")) %>%
  # Select columns
...
hscrp20212023 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2021-2023/HSCRP_L.XPT")) %>%
  # Select columns
...
huq20212023 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2021-2023/HUQ_L.XPT")) %>%
  # Select columns
...
ins20212023 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2021-2023/INS_L.XPT")) %>%
  # Select columns
...
kiq20212023 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2021-2023/KIQ_U_L.XPT")) %>%
  # Select columns
...
mcq20212023 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2021-2023/MCQ_L.XPT")) %>%
  # Select columns
...
rxqasa20212023 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2021-2023/RXQASA_L.XPT")) %>%
  # Select columns
...
smq20212023 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2021-2023/SMQ_L.XPT")) %>%
  # Select columns
...
smqrtu20212023 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2021-2023/SMQRTU_L.XPT")) %>%
  # Select columns
...
tchol20212023 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2021-2023/TCHOL_L.XPT")) %>%
  # Select columns
...
saveRDS(nhanes_20212023, file = paste0(path_nhanes_ckm_cleaned,"/nhanes_20212023.rds"))
