...
# For 2009-2010
alb20092010 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2009-2010/ALB_CR_F.XPT")) %>%
  # Select columns
...
biopro20092010 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2009-2010/BIOPRO_F.XPT")) %>%
  # Select columns
...
bmx20092010 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2009-2010/BMX_F.XPT")) %>%
  # Select columns
...
bpq20092010 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2009-2010/BPQ_F.XPT")) %>%
  # Select columns
...
bpx20092010 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2009-2010/BPX_F.XPT")) %>%
  # Select columns
...
cdq20092010 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2009-2010/CDQ_F.XPT")) %>%
  # Select columns
...
demo20092010 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2009-2010/DEMO_F.XPT")) %>%
  # Select columns
...
diq20092010 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2009-2010/DIQ_F.XPT")) %>%
  # Select columns
...
fastqx20092010 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2009-2010/FASTQX_F.XPT")) %>%
  # Select columns
...
ghb20092010 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2009-2010/GHB_F.XPT")) %>%
  # Select columns
...
glu20092010 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2009-2010/GLU_F.XPT")) %>%
  # Select columns
...
hdl20092010 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2009-2010/HDL_F.XPT")) %>%
  # Select columns
...
huq20092010 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2009-2010/HUQ_F.XPT")) %>%
  # Select columns
...
ins20092010 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2009-2010/GLU_F.XPT")) %>%
  # Select columns
...
kiq20092010 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2009-2010/KIQ_U_F.XPT")) %>%
  # Select columns
...
mcq20092010 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2009-2010/MCQ_F.XPT")) %>%
  # Select columns
...
ogtt20092010 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2009-2010/OGTT_F.XPT")) %>%
  # Select columns
...
smq20092010 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2009-2010/SMQ_F.XPT")) %>%
  # Select columns
...
smqrtu20092010 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2009-2010/SMQRTU_F.XPT")) %>%
  # Select columns
...
tchol20092010 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2009-2010/TCHOL_F.XPT")) %>%
  # Select columns
...
trigly20092010 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2009-2010/TRIGLY_F.XPT")) %>%
  # Select columns
...
hiq20092010 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2009-2010/hiq_F.XPT")) %>%
  # Select columns
...
saveRDS(nhanes_20092010, file = paste0(path_nhanes_ckm_cleaned,"/nhanes_20092010.rds"))
