...
#select variables 
selected_variables = ["respondentid", "dm_age", "bmi", "glycohemoglobin", "homa2b", "homa2ir", 
...
# 5 clustering variables (age at diagnosis, BMI, HbA1c, HOMA2-B, HOMA2-IR) + 
# 9 auxiliary variables (LDL chol, HDL chol, triglycerides, ALT, AST, SBP, DBP, egfr, waist circumference) 
columns_to_impute = ["bmi","dm_age","glycohemoglobin","homa2b", "homa2ir",
                     "hdl", "ldl",  "triglyceride", "alt", "ast", "sbp", "dbp", "egfr", "waistcircumference"]
