...
alb20172018 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2017-2018/ALB_CR_J.XPT")) %>%
  # Select columns
...
biopro20172018 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2017-2018/BIOPRO_J.XPT")) %>%
  # Select columns
...
bmx20172018 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2017-2018/BMX_J.XPT")) %>%
  # Select columns
...
bpq20172018 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2017-2018/BPQ_J.XPT")) %>%
  # Select columns
...
bpx20172018 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2017-2018/BPX_J.XPT")) %>%
  # Select columns
...
cdq20172018 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2017-2018/CDQ_J.XPT")) %>%
  # Select columns
...
demo20172018 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2017-2018/DEMO_J.XPT")) %>%
  # Select columns
...
diq20172018 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2017-2018/DIQ_J.XPT")) %>%
  # Select columns
...
fastqx20172018 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2017-2018/FASTQX_J.XPT")) %>%
  # Select columns
...
ghb20172018 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2017-2018/GHB_J.XPT")) %>%
  # Select columns
...
glu20172018 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2017-2018/GLU_J.XPT")) %>%
  # Select columns
...
hdl20172018 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2017-2018/HDL_J.XPT")) %>%
  # Select columns
...
hscrp20172018 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2017-2018/HSCRP_J.XPT")) %>%
  # Select columns
...
huq20172018 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2017-2018/HUQ_J.XPT")) %>%
  # Select columns
...
ins20172018 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2017-2018/INS_J.XPT")) %>%
  # Select columns
...
kiq20172018 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2017-2018/KIQ_U_J.XPT")) %>%
  # Select columns
...
mcq20172018 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2017-2018/MCQ_J.XPT")) %>%
  # Select columns
...
rxqasa20172018 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2017-2018/RXQASA_J.XPT")) %>%
  # Select columns
...
smq20172018 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2017-2018/SMQ_J.XPT")) %>%
  # Select columns
...
smqrtu20172018 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2017-2018/SMQRTU_J.XPT")) %>%
  # Select columns
...
ssagp20172018 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2017-2018/SSAGP_J.XPT")) %>%
  # Select columns
...
tchol20172018 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2017-2018/TCHOL_J.XPT")) %>%
  # Select columns
...
trigly20172018 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2017-2018/TRIGLY_J.XPT")) %>%
  # Select columns
...
dxx20172018 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2017-2018/DXX_J.XPT")) %>%
  # Select columns
...
hiq20172018 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2017-2018/hiq_J.XPT")) %>%
  # Select columns
...
saveRDS(nhanes_20172018, file = paste0(path_nhanes_nsb_cleaned,"/nhanes_20172018.rds"))
