...
# For 2003-2004
alb20032004 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2003-2004/L16_C.XPT")) %>%
  # Select columns
...
biopro20032004 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2003-2004/L40_C.XPT")) %>%
  # Select columns
...
bmx20032004 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2003-2004/BMX_C.XPT")) %>%
  # Select columns
...
bpq20032004 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2003-2004/BPQ_C.XPT")) %>%
  # Select columns
...
bpx20032004 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2003-2004/BPX_C.XPT")) %>%
  # Select columns
...
cdq20032004 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2003-2004/CDQ_C.XPT")) %>%
  # Select columns
...
demo20032004 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2003-2004/DEMO_C.XPT")) %>%
  # Select columns
...
diq20032004 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2003-2004/DIQ_C.XPT")) %>%
  # Select columns
...
fastqx20032004 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2003-2004/PH_C.XPT")) %>%
  # Select columns
...
ghb20032004 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2003-2004/L10_C.XPT")) %>%
  # Select columns
...
glu20032004 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2003-2004/L10AM_C.XPT")) %>%
  # Select columns
...
hdl20032004 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2003-2004/L13_C.XPT")) %>%
  # Select columns
...
huq20032004 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2003-2004/HUQ_C.XPT")) %>%
  # Select columns
...
ins20032004 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2003-2004/L10AM_C.XPT")) %>%
  # Select columns
...
kiq20032004 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2003-2004/KIQ_U_C.XPT")) %>%
  # Select columns
...
mcq20032004 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2003-2004/MCQ_C.XPT")) %>%
  # Select columns
...
smq20032004 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2003-2004/SMQ_C.XPT")) %>%
  # Select columns
...
smqrtu20032004 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2003-2004/SMQMEC_C.XPT")) %>%
  # Select columns
...
trigly20032004 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2003-2004/L13AM_C.XPT")) %>%
  # Select columns
...
dxx20032004 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2003-2004/dxx_C.XPT")) %>%
  # Select columns
...
hiq20032004 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2003-2004/hiq_c.XPT")) %>%
  # Select columns
...
saveRDS(nhanes_20032004, file = paste0(path_nhanes_nsb_cleaned,"/nhanes_20032004.rds"))
