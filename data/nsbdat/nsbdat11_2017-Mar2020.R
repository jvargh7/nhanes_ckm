...
alb2017Mar2020 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2017-Mar2020/P_ALB_CR.XPT")) %>%
  # Select columns
...
biopro2017Mar2020 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2017-Mar2020/P_BIOPRO.XPT")) %>%
  # Select columns
...
bmx2017Mar2020 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2017-Mar2020/P_BMX.XPT")) %>%
  # Select columns
...
bpq2017Mar2020 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2017-Mar2020/P_BPQ.XPT")) %>%
  # Select columns
...
bpxo2017Mar2020 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2017-Mar2020/P_BPXO.XPT")) %>%
  # Select columns
...
cdq2017Mar2020 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2017-Mar2020/P_CDQ.XPT")) %>%
  # Select columns
...
demo2017Mar2020 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2017-Mar2020/P_DEMO.XPT")) %>%
  # Select columns
...
diq2017Mar2020 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2017-Mar2020/P_DIQ.XPT")) %>%
  # Select columns
...
fastqx2017Mar2020 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2017-Mar2020/P_FASTQX.XPT")) %>%
  # Select columns
...
ghb2017Mar2020 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2017-Mar2020/P_GHB.XPT")) %>%
  # Select columns
...
glu2017Mar2020 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2017-Mar2020/P_GLU.XPT")) %>%
  # Select columns
...
hdl2017Mar2020 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2017-Mar2020/P_HDL.XPT")) %>%
  # Select columns
...
hscrp2017Mar2020 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2017-Mar2020/P_HSCRP.XPT")) %>%
  # Select columns
...
huq2017Mar2020 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2017-Mar2020/P_HUQ.XPT")) %>%
  # Select columns
...
inq2017Mar2020 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2017-Mar2020/P_INQ.XPT")) %>%
  # Select columns
...
ins2017Mar2020 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2017-Mar2020/P_INS.XPT")) %>%
  # Select columns
...
kiq2017Mar2020 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2017-Mar2020/P_KIQ_U.XPT")) %>%
  # Select columns
...
mcq2017Mar2020 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2017-Mar2020/P_MCQ.XPT")) %>%
  # Select columns
...
rxqasa2017Mar2020 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2017-Mar2020/P_RXQASA.XPT")) %>%
  # Select columns
...
smq2017Mar2020 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2017-Mar2020/P_SMQ.XPT")) %>%
  # Select columns
...
smqrtu2017Mar2020 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2017-Mar2020/P_SMQRTU.XPT")) %>%
  # Select columns
...
ssagp2017Mar2020 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2017-Mar2020/P_SSAGP.XPT")) %>%
  # Select columns
...
tchol2017Mar2020 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2017-Mar2020/P_TCHOL.XPT")) %>%
  # Select columns
...
trigly2017Mar2020 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2017-Mar2020/P_TRIGLY.XPT")) %>%
  # Select columns
...
hiq2017Mar2020 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2017-Mar2020/P_hiq.XPT")) %>%
  # Select columns
...
saveRDS(nhanes_2017Mar2020, file = paste0(path_nhanes_nsb_cleaned,"/nhanes_2017Mar2020.rds"))
