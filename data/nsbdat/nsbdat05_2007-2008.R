...
# For 2007-2008
alb20072008 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2007-2008/ALB_CR_E.XPT")) %>%
  # Select columns
...
biopro20072008 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2007-2008/BIOPRO_E.XPT")) %>%
  # Select columns
...
bmx20072008 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2007-2008/BMX_E.XPT")) %>%
  # Select columns
...
bpq20072008 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2007-2008/BPQ_E.XPT")) %>%
  # Select columns
...
bpx20072008 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2007-2008/BPX_E.XPT")) %>%
  # Select columns
...
cdq20072008 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2007-2008/CDQ_E.XPT")) %>%
  # Select columns
...
demo20072008 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2007-2008/DEMO_E.XPT")) %>%
  # Select columns
...
diq20072008 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2007-2008/DIQ_E.XPT")) %>%
  # Select columns
...
fastqx20072008 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2007-2008/FASTQX_E.XPT")) %>%
  # Select columns
...
ghb20072008 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2007-2008/GHB_E.XPT")) %>%
  # Select columns
...
glu20072008 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2007-2008/GLU_E.XPT")) %>%
  # Select columns
...
hdl20072008 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2007-2008/HDL_E.XPT")) %>%
  # Select columns
...
huq20072008 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2007-2008/HUQ_E.XPT")) %>%
  # Select columns
...
ins20072008 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2007-2008/GLU_E.XPT")) %>%
  # Select columns
...
kiq20072008 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2007-2008/KIQ_U_E.XPT")) %>%
  # Select columns
...
mcq20072008 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2007-2008/MCQ_E.XPT")) %>%
  # Select columns
...
ogtt20072008 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2007-2008/OGTT_E.XPT")) %>%
  # Select columns
...
smq20072008 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2007-2008/SMQ_E.XPT")) %>%
  # Select columns
...
smqrtu20072008 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2007-2008/SMQRTU_E.XPT")) %>%
  # Select columns
...
tchol20072008 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2007-2008/TCHOL_E.XPT")) %>%
  # Select columns
...
trigly20072008 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2007-2008/TRIGLY_E.XPT")) %>%
  # Select columns
...
hiq20072008 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2007-2008/hiq_E.XPT")) %>%
  # Select columns
...
saveRDS(nhanes_20072008, file = paste0(path_nhanes_nsb_cleaned,"/nhanes_20072008.rds"))
