...
# For 2013-2014
alb20132014 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2013-2014/ALB_CR_H.XPT")) %>%
  # Select columns
...
biopro20132014 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2013-2014/BIOPRO_H.XPT")) %>%
  # Select columns
...
bmx20132014 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2013-2014/BMX_H.XPT")) %>%
  # Select columns
...
bpq20132014 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2013-2014/BPQ_H.XPT")) %>%
  # Select columns
...
bpx20132014 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2013-2014/BPX_H.XPT")) %>%
  # Select columns
...
cdq20132014 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2013-2014/CDQ_H.XPT")) %>%
  # Select columns
...
demo20132014 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2013-2014/DEMO_H.XPT")) %>%
  # Select columns
...
diq20132014 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2013-2014/DIQ_H.XPT")) %>%
  # Select columns
...
fastqx20132014 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2013-2014/FASTQX_H.XPT")) %>%
  # Select columns
...
ghb20132014 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2013-2014/GHB_H.XPT")) %>%
  # Select columns
...
glu20132014 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2013-2014/GLU_H.XPT")) %>%
  # Select columns
...
hdl20132014 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2013-2014/HDL_H.XPT")) %>%
  # Select columns
...
huq20132014 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2013-2014/HUQ_H.XPT")) %>%
  # Select columns
...
ins20132014 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2013-2014/INS_H.XPT")) %>%
  # Select columns
...
kiq20132014 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2013-2014/KIQ_U_H.XPT")) %>%
  # Select columns
...
mcq20132014 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2013-2014/MCQ_H.XPT")) %>%
  # Select columns
...
ogtt20132014 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2013-2014/OGTT_H.XPT")) %>%
  # Select columns
...
rxqasa20132014 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2013-2014/RXQASA_H.XPT")) %>%
  # Select columns
...
smq20132014 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2013-2014/SMQ_H.XPT")) %>%
  # Select columns
...
smqrtu20132014 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2013-2014/SMQRTU_H.XPT")) %>%
  # Select columns
...
tchol20132014 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2013-2014/TCHOL_H.XPT")) %>%
  # Select columns
...
trigly20132014 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2013-2014/TRIGLY_H.XPT")) %>%
  # Select columns
...
dxx20132014 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2013-2014/DXX_H.XPT")) %>%
  # Select columns
  select(all_of(na.omit(dxx_variables$`2013-2014`))) %>%
  # Rename columns
...
hiq20132014 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2013-2014/hiq_H.XPT")) %>%
  # Select columns
  select(all_of(na.omit(hiq_variables$`2013-2014`))) %>%
  # Rename columns
  rename_with(~ hiq_variables[!is.na(hiq_variables$`2013-2014`),]$variable[which(na.omit(hiq_variables$`2013-2014`) == .x)], 
              .cols = na.omit(hiq_variables$`2013-2014`))
...
saveRDS(nhanes_20132014, file = paste0(path_nhanes_nsb_cleaned,"/nhanes_20132014.rds"))
