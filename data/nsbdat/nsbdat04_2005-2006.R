...
# For 2005-2006
alb20052006 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2005-2006/ALB_CR_D.XPT")) %>%
  # Select columns
...
biopro20052006 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2005-2006/BIOPRO_D.XPT")) %>%
  # Select columns
...
bmx20052006 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2005-2006/BMX_D.XPT")) %>%
  # Select columns
...
bpq20052006 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2005-2006/BPQ_D.XPT")) %>%
  # Select columns
...
bpx20052006 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2005-2006/BPX_D.XPT")) %>%
  # Select columns
...
cdq20052006 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2005-2006/CDQ_D.XPT")) %>%
  # Select columns
...
demo20052006 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2005-2006/DEMO_D.XPT")) %>%
  # Select columns
...
diq20052006 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2005-2006/DIQ_D.XPT")) %>%
  # Select columns
...
fastqx20052006 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2005-2006/FASTQX_D.XPT")) %>%
  # Select columns
...
ghb20052006 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2005-2006/GHB_D.XPT")) %>%
  # Select columns
...
glu20052006 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2005-2006/GLU_D.XPT")) %>%
  # Select columns
...
hdl20052006 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2005-2006/HDL_D.XPT")) %>%
  # Select columns
...
huq20052006 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2005-2006/HUQ_D.XPT")) %>%
  # Select columns
...
ins20052006 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2005-2006/GLU_D.XPT")) %>%
  # Select columns
...
kiq20052006 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2005-2006/KIQ_U_D.XPT")) %>%
  # Select columns
...
mcq20052006 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2005-2006/MCQ_D.XPT")) %>%
  # Select columns
...
ogtt20052006 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2005-2006/OGTT_D.XPT")) %>%
  # Select columns
...
smq20052006 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2005-2006/SMQ_D.XPT")) %>%
  # Select columns
...
smqrtu20052006 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2005-2006/SMQRTU_D.XPT")) %>%
  # Select columns
...
tchol20052006 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2005-2006/TCHOL_D.XPT")) %>%
  # Select columns
...
trigly20052006 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2005-2006/TRIGLY_D.XPT")) %>%
  # Select columns
...
dxx20052006 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2005-2006/dxx_D.XPT")) %>%
  # Select columns
  select(all_of(na.omit(dxx_variables$`2005-2006`))) %>%
  # Rename columns
  rename_with(~ dxx_variables[!is.na(dxx_variables$`2005-2006`),]$variable[which(na.omit(dxx_variables$`2005-2006`) == .x)], 
              .cols = na.omit(dxx_variables$`2005-2006`))

dxx20052006_avg <- dxx20052006 %>%
  group_by(respondentid) %>%
  summarise(across(where(is.numeric), ~ mean(.x, na.rm = TRUE)))

hiq20052006 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2005-2006/hiq_D.XPT")) %>%
  # Select columns
  select(all_of(na.omit(hiq_variables$`2005-2006`))) %>%
  # Rename columns
  rename_with(~ hiq_variables[!is.na(hiq_variables$`2005-2006`),]$variable[which(na.omit(hiq_variables$`2005-2006`) == .x)], 
              .cols = na.omit(hiq_variables$`2005-2006`))
...
nhanes_20052006 <- alb20052006 %>%
  ...
  left_join(dxx20052006_avg, by = "respondentid") %>%
  left_join(hiq20052006, by = "respondentid")

# Adding eGFR variable according to (https://www.kidney.org/ckd-epi-creatinine-equation-2021):
nhanes_20052006 <- nhanes_20052006 %>%
  dplyr::mutate(
...
saveRDS(nhanes_20052006, file = paste0(path_nhanes_nsb_cleaned,"/nhanes_20052006.rds"))
