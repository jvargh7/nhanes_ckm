...
# For 2001-2002
alb20012002 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2001-2002/L16_B.XPT")) %>%
  # Select columns
...
biopro20012002 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2001-2002/L40_B.XPT")) %>%
  # Select columns
...
bmx20012002 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2001-2002/BMX_B.XPT")) %>%
  # Select columns
...
bpq20012002 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2001-2002/BPQ_B.XPT")) %>%
  # Select columns
...
bpx20012002 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2001-2002/BPX_B.XPT")) %>%
  # Select columns
...
cdq20012002 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2001-2002/CDQ_B.XPT")) %>%
  # Select columns
...
demo20012002 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2001-2002/DEMO_B.XPT")) %>%
  # Select columns
...
diq20012002 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2001-2002/DIQ_B.XPT")) %>%
  # Select columns
...
fastqx20012002 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2001-2002/PH_B.XPT")) %>%
  # Select columns
...
ghb20012002 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2001-2002/L10_B.XPT")) %>%
  # Select columns
...
glu20012002 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2001-2002/L10AM_B.XPT")) %>%
  # Select columns
...
hdl20012002 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2001-2002/L13_B.XPT")) %>%
  # Select columns
...
huq20012002 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2001-2002/HUQ_B.XPT")) %>%
  # Select columns
...
ins20012002 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2001-2002/L10AM_B.XPT")) %>%
  # Select columns
...
kiq20012002 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2001-2002/KIQ_U_B.XPT")) %>%
  # Select columns
...
mcq20012002 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2001-2002/MCQ_B.XPT")) %>%
  # Select columns
...
smq20012002 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2001-2002/SMQ_B.XPT")) %>%
  # Select columns
...
smqrtu20012002 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2001-2002/SMQMEC_B.XPT")) %>%
  # Select columns
...
trigly20012002 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2001-2002/L13AM_B.XPT")) %>%
  # Select columns
...
dxx20012002 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2001-2002/dxx_b.XPT")) %>%
  # Select columns
...
hiq20012002 <- read_xpt(paste0(path_nhanes_nsb_raw,"/2001-2002/hiq_b.XPT")) %>%
  # Select columns
...
saveRDS(nhanes_20012002, file = paste0(path_nhanes_nsb_cleaned,"/nhanes_20012002.rds"))
