...
# For 2015-2016:
alb20152016 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2015-2016/ALB_CR_I.XPT")) %>%
  # Select columns
...
biopro20152016 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2015-2016/BIOPRO_I.XPT")) %>%
  # Select columns
...
bmx20152016 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2015-2016/BMX_I.XPT")) %>%
  # Select columns
...
bpq20152016 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2015-2016/BPQ_I.XPT")) %>%
  # Select columns
...
bpx20152016 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2015-2016/BPX_I.XPT")) %>%
  # Select columns
...
cdq20152016 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2015-2016/CDQ_I.XPT")) %>%
  # Select columns
...
demo20152016 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2015-2016/DEMO_I.XPT")) %>%
  # Select columns
...
diq20152016 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2015-2016/DIQ_I.XPT")) %>%
  # Select columns
...
fastqx20152016 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2015-2016/FASTQX_I.XPT")) %>%
  # Select columns
...
ghb20152016 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2015-2016/GHB_I.XPT")) %>%
  # Select columns
...
glu20152016 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2015-2016/GLU_I.XPT")) %>%
  # Select columns
...
hdl20152016 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2015-2016/HDL_I.XPT")) %>%
  # Select columns
...
hscrp20152016 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2015-2016/HSCRP_I.XPT")) %>%
  # Select columns
...
huq20152016 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2015-2016/HUQ_I.XPT")) %>%
  # Select columns
...
ins20152016 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2015-2016/INS_I.XPT")) %>%
  # Select columns
...
kiq20152016 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2015-2016/KIQ_U_I.XPT")) %>%
  # Select columns
...
mcq20152016 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2015-2016/MCQ_I.XPT")) %>%
  # Select columns
...
ogtt20152016 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2015-2016/OGTT_I.XPT")) %>%
  # Select columns
...
rxqasa20152016 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2015-2016/RXQASA_I.XPT")) %>%
  # Select columns
...
smq20152016 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2015-2016/SMQ_I.XPT")) %>%
  # Select columns
...
smqrtu20152016 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2015-2016/SMQRTU_I.XPT")) %>%
  # Select columns
...
ssagp20152016 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2015-2016/SSAGP_I.XPT")) %>%
  # Select columns
...
tchol20152016 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2015-2016/TCHOL_I.XPT")) %>%
  # Select columns
...
trigly20152016 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2015-2016/TRIGLY_I.XPT")) %>%
  # Select columns
...
dxxag20152016 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2015-2016/DXXAG_I.XPT")) %>%
  # Select columns
  select(all_of(na.omit(dxxag_variables$`2015-2016`))) %>%
  # Rename columns
  rename_with(~ dxxag_variables[!is.na(dxxag_variables$`2015-2016`),]$variable[which(na.omit(dxxag_variables$`2015-2016`) == .x)], 
              .cols = na.omit(dxxag_variables$`2015-2016`))

hiq20152016 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2015-2016/hiq_I.XPT")) %>%
  # Select columns
...
nhanes_20152016 <- alb20152016 %>%
  ...
  left_join(dxxag20152016, by = "respondentid")
