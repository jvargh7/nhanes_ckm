...
# For 2011-2012
alb20112012 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2011-2012/ALB_CR_G.XPT")) %>%
  # Select columns
...
biopro20112012 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2011-2012/BIOPRO_G.XPT")) %>%
  # Select columns
...
bmx20112012 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2011-2012/BMX_G.XPT")) %>%
  # Select columns
...
bpq20112012 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2011-2012/BPQ_G.XPT")) %>%
  # Select columns
...
bpx20112012 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2011-2012/BPX_G.XPT")) %>%
  # Select columns
...
cdq20112012 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2011-2012/CDQ_G.XPT")) %>%
  # Select columns
...
demo20112012 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2011-2012/DEMO_G.XPT")) %>%
  # Select columns
...
diq20112012 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2011-2012/DIQ_G.XPT")) %>%
  # Select columns
...
fastqx20112012 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2011-2012/FASTQX_G.XPT")) %>%
  # Select columns
...
ghb20112012 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2011-2012/GHB_G.XPT")) %>%
  # Select columns
...
glu20112012 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2011-2012/GLU_G.XPT")) %>%
  # Select columns
...
hdl20112012 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2011-2012/HDL_G.XPT")) %>%
  # Select columns
...
huq20112012 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2011-2012/HUQ_G.XPT")) %>%
  # Select columns
...
ins20112012 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2011-2012/GLU_G.XPT")) %>%
  # Select columns
...
kiq20112012 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2011-2012/KIQ_U_G.XPT")) %>%
  # Select columns
...
mcq20112012 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2011-2012/MCQ_G.XPT")) %>%
  # Select columns
...
ogtt20112012 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2011-2012/OGTT_G.XPT")) %>%
  # Select columns
...
rxqasa20112012 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2011-2012/RXQASA_G.XPT")) %>%
  # Select columns
...
smq20112012 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2011-2012/SMQ_G.XPT")) %>%
  # Select columns
...
smqrtu20112012 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2011-2012/SMQRTU_G.XPT")) %>%
  # Select columns
...
tchol20112012 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2011-2012/TCHOL_G.XPT")) %>%
  # Select columns
...
trigly20112012 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2011-2012/TRIGLY_G.XPT")) %>%
  # Select columns
...
dxx20112012 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2011-2012/DXX_G.XPT")) %>%
  # Select columns
...
dxxag20112012 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2011-2012/DXXAG_G.XPT")) %>%
  # Select columns
  select(all_of(na.omit(dxxag_variables$`2011-2012`))) %>%
  # Rename columns
  rename_with(~ dxxag_variables[!is.na(dxxag_variables$`2011-2012`),]$variable[which(na.omit(dxxag_variables$`2011-2012`) == .x)], 
              .cols = na.omit(dxxag_variables$`2011-2012`))

hiq20112012 <- read_xpt(paste0(path_nhanes_ckm_raw,"/2011-2012/hiq_G.XPT")) %>%
  # Select columns
...
nhanes_20112012 <- alb20112012 %>%
  ...
  left_join(dxxag20112012, by = "respondentid")
...
saveRDS(nhanes_20112012, file = paste0(path_nhanes_ckm_cleaned,"/nhanes_20112012.rds"))
