...
# Filter the dataset for rows from years 2015-2016 or 2017-2018
filtered_dataset = analytic_dataset[(analytic_dataset['year'] == 20152016) |
                                    (analytic_dataset['year'] == 20172018)]
...
analytic_dataset_cluster['cluster'] = analytic_dataset_cluster['cluster'].replace({0: 'MOD', 1: 'SIDD', 2: 'MARD', 3: 'SIRD'})
...
analytic_dataset_cluster.to_csv(path_nhanes_ckm_folder + '/working/new diabetes/knn_clusters_2015_2018.csv', index=False)
...
data_scaled_cluster['cluster'] = data_scaled_cluster['cluster'].replace({0: 'MOD', 1: 'SIDD', 2: 'MARD', 3: 'SIRD'})
...
plt.title('Variables by Clusters (2015-2018)')
plt.xlabel('Cluster')
plt.ylabel('Value')
...
plt.savefig(path_nhanes_ckm_folder + '/figures/boxplot_clusters_2015_2018.png', format='png', dpi=300, bbox_inches='tight')
