...
overall_summary <- data.frame(
  ...
  Household_Income_Under_20k = prop_ci_category_survey("hhincome", c(1, 2, 3, 4), analytic_sample_svy),
  ...
  Household_Income_75k_to_100k = prop_ci_category_survey("hhincome", 14, analytic_sample_svy),
  Household_Income_Over_100k = prop_ci_category_survey("hhincome", 15, analytic_sample_svy),
...
for (cluster_id in clusters) {
  ...
  cluster_data <- data.frame(
    ...
    Household_Income_Under_20k = prop_ci_category_survey("hhincome", c(1, 2, 3, 4), cluster_design),
    ...
    Household_Income_75k_to_100k = prop_ci_category_survey("hhincome", 14, cluster_design),
    Household_Income_Over_100k = prop_ci_category_survey("hhincome", 15, cluster_design),
