...
overall_summary <- data.frame(
  ...
  Household_Income_Under_20k = prop_ci_category_unweighted("hhincome", c(1, 2, 3, 4), analytic_sample),
  ...
  Household_Income_75k_to_100k = prop_ci_category_unweighted("hhincome", 14, analytic_sample),
  Household_Income_Over_100k = prop_ci_category_unweighted("hhincome", 15, analytic_sample),
...
for (cluster_id in clusters) {
  ...
  cluster_summary_row <- data.frame(
    ...
    Household_Income_Under_20k = prop_ci_category_unweighted("hhincome", c(1, 2, 3, 4), cluster_data),
    ...
    Household_Income_75k_to_100k = prop_ci_category_unweighted("hhincome", 14, cluster_data),
    Household_Income_Over_100k = prop_ci_category_unweighted("hhincome", 15, cluster_data),
...
excluded_summary <- data.frame(
  ...
  Household_Income_Under_20k = prop_ci_category_unweighted("hhincome", c(1, 2, 3, 4), excluded_sample),
  ...
  Household_Income_75k_to_100k = prop_ci_category_unweighted("hhincome", 14, excluded_sample),
  Household_Income_Over_100k = prop_ci_category_unweighted("hhincome", 15, excluded_sample),
